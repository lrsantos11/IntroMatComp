...
# ╔═╡ 2c57f956-51bb-43d4-951e-35e65d463dd2
typeof(1.)

# ╔═╡ f3cd1ee2-ec63-4c22-b0ae-72dee732c4e6
typeof(1.e-2)
...
# ╔═╡ 3c14b482-c725-4e5d-83a6-ed4c6cf0809c
eps(1e10)
...
begin
	plt2 = plot!(x,-log_erro_me,xaxis=:log10, label="Função")
	title!("Dígitos corretos em função de x - expressão melhorada")
	ylabel!("Dígitos corretos")
	xlabel!("x")
end

# ╔═╡ 5f8abe71-a6e1-4ec3-8be4-ca6169883c6a
...
manifest_format = "2.0"
project_hash = "a13dd6f9886c94a925d8bb34358f1d189196ee72"
