...
1. Precisão simples: $\epsilon_{mac} \approx 1.19209 \cdot 10^{-7}$. No julia os números em precisão simples tem _type_ `Float32`

1. Precisão dupla: $\epsilon_{mac} \approx 2.22045 \cdot 10^{-16}$. No julia os números em precisão dupla tem _type_ `Float64`
...
# ╔═╡ dbaa0d79-04af-463f-abee-23d2a212d5a9

typeof(1)


# ╔═╡ 654d70e0-283c-429c-84d7-1372f996e7a1

typeof(1.0f-2)


# ╔═╡ ecdb1e7d-8cf6-443f-97da-e61ec7ad9964
...
begin
	plt1 = plot(x,-log_erro,xaxis=:log10,leg=false) 
...
begin
	plt2 = plot!(plt1, x,-log_erro_me,xaxis=:log10, label="Função")
...
md"""
---
## Nota: a mesma ideia aparece na fórmula de Báskara

O mesmo fenômeno de cancelamento ocorre ao resolver $ax^2+bx+c=0$ pela fórmula de Báskara quando $-b$ e $\sqrt{\Delta}$ têm módulos próximos. A correção usa $r_1$ (raiz sem cancelamento) e depois $r_2 = c/r_1$ (produto das raízes), evitando outra subtração problemática. *(ver notebook de referência para o exemplo completo)*
"""

# ╔═╡ bbbb0002-0000-4000-8000-000000000002
md"""
---
## Bônus (se sobrar tempo): ordem de soma importa
"""
...
manifest_format = "2.0"
project_hash = "8cb19e8c728c33d4c4261d8912421a3df8ceb190"
