...
# ╔═╡ 32ed6d86-01b9-4451-991f-a0b1646781f3
@bind var_rafa Slider(100:-2:2)

# ╔═╡ e3206c9b-beca-457e-9f87-c1216bb91edd
println(var_rafa)
...
function fatorial_iter(n)
    ...
    return fat   # remova esta linha quando implementar
end
...
# ╔═╡ bf9d01c2-b3dc-4845-b9cb-8db37838cd5e
...
let
    ...
    concorda = fibonacci_iter(40) == fibonacci_rec(40) # rescue false
    if obtido == esperado
...
manifest_format = "2.0"
project_hash = "3c2f299240b20a597a3c536992d65d2cebf81132"
