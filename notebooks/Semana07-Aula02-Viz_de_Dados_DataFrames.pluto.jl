...
df_metrosp = CSV.read("metro_sp.csv", DataFrame)
...
# ╔═╡ 49502cf7-27b6-4f2a-b13e-05aaff52715e
gdf_metrosp = groupby(df_metrosp, :line)

# ╔═╡ 3893c7c5-4272-4e3d-9eca-55680f87d670
nrow(df_metrosp)

# ╔═╡ af38b8cd-34e9-40e9-8538-42621ad04ffd
combine(gdf_metrosp, nrow => :total_est)
...
combine(groupby(df_metrosp, :line), :lat => minimum => :lat_mais_ao_sul)
...
**Observações:** 
- Suba um Notebook Pluto com o nome `Tarefa_Semana07_Meu_Nome.pluto.jl` na atividade específica no Moodle agregando as resoluções da Aula 02.
...
manifest_format = "2.0"
project_hash = "c42c33ee589129f6dcb8d5ae0c341ea99b9aa506"
