...
# ╔═╡ 487774f0-bb57-43e7-a361-d42ea0bdf9e6
begin 
	using Random 
	using LinearAlgebra
	using StatsBase
...
# ╔═╡ 31a3b866-d756-11f0-a9d7-bdc2c733b94c
md"""
## UFSC/Blumenau
...
# ╔═╡ e5782989-fd73-4dd1-8c43-1c8cbeb8f5ea
md"""
...
# ╔═╡ 09a1e7af-c446-423a-8698-e67b6bf198d4
begin
	Random.seed!(42)
	n_cervejas = 20
...
# ╔═╡ d8da8124-b35d-442a-9e91-e6ae1863d365
...
# ╔═╡ 77737b09-fe6f-4922-97a6-fd7e5a65152e
# Vamos olhar para os dados!
df = DataFrame(X_bruto, nomes_colunas)

# ╔═╡ 2cc4528f-a7b9-432b-a8d9-3ddf2d01a59f
md"""
...
# ╔═╡ 2ea1ac0e-71cd-41a2-a2b8-1df1b38770f5
begin
...
# ╔═╡ 4830d37f-a7cf-420f-a1e4-65590b18216c
	md"Dados centralizados. Média de cada coluna agora é praticamente zero."


# ╔═╡ 89285df1-651c-4efa-a655-7d07633c6480
X_cent

# ╔═╡ c7d9f9ea-abdc-4231-b92b-3b503352393c
[mean(col) for col in eachcol(X_cent)]

# ╔═╡ dec84da1-cc4b-474c-abb1-5927a4a73638
begin
...
# ╔═╡ 2dd57ab6-569c-4de0-ae2b-8630617ba283
sigma

# ╔═╡ 0faa1053-a3de-4f4b-8547-d1a15e64097b
	md"SVD calculada!"


# ╔═╡ 3235a133-736b-48a6-a967-996fe4840400
begin
...
# ╔═╡ b26b5da5-1605-4444-9991-fe7154626b8e
variancia_relativa

# ╔═╡ 6512f972-3b16-48d5-954c-ac77a5619232
begin
...
# ╔═╡ dca362b5-3c6f-4401-b060-8a37ba2a9cdc
X_2D

# ╔═╡ d2fac513-b5c4-4556-8a41-46361b6511ee
begin
...
# ╔═╡ 71a11465-e9ea-4794-9145-4d4d2af82cfd
md"""
